...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/navanchauhan/libghostty-spm/releases/download/storage.1.0.1776871802/GhosttyKit.xcframework.zip",
            checksum: "33dc2bcc9fcb5134ff61a7d70e4ad0f4137519c06fc4057ee07cbb35d0b23cd2"
        ),
        .testTarget(
            name: "GhosttyKitTest",
